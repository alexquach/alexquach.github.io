...
function AnimatedPentagon(props) {
  return (
    <svg
      viewBox="0 0 943.92 902.15"
      data-llp-composed="true"
      id="prefix__Pentagon_Component"
    ...
    >
      <defs>
        <style>
          {
            ".prefix__cls-1{fill:none;stroke:#231f20;stroke-miterlimit:10;stroke-width:8px}"
          }
        </style>
      </defs>
...
const MemoAnimatedPentagon = React.memo(AnimatedPentagon);
export default MemoAnimatedPentagon;
