...
window.onresize = function() {
  ...
  document.querySelector('canvas').width = window.innerWidth; //reset canvas width
  document.querySelector('canvas').height = window.innerHeight; //reset canvas height
  everything();
}
...
function everything() {
  ...
  var height = canvas.height = window.innerHeight * 0.875;
